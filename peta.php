...
<script src="https://maps.googleapis.com/maps/api/js?sensor="></script>
//<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBi2nH0JZ2vXuHChjXGDmPR9sKYVFWwyTE"></script>
...
var officeLocations = [
<?php
$data = file_get_contents('http://localhost/public_html/ambildata.php');
                $no=1;
